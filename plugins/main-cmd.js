...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+923025621916'; // Replace this with the actual owner number
        const ownerName = 'Fm abdullah'; // Replace this with the owner's name
        const organization = 'FM CORDER'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+923124001592', '') + '+923124001592@s.whatsapp.net'], // Mention the owner
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_ABDULLAH-MD..._*'  }, { quoted: mek } )
